...
import { useIsMobile } from "@shopwise/ui/hooks/use-mobile";
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@shopwise/ui/components/sheet";
import { Skeleton } from "@shopwise/ui/components/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@shopwise/ui/components/tooltip";
...
const SidebarRail = ({
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 transition-[background-color] duration-200 ease-[var(--ease-out)] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
