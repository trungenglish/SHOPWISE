...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@shopwise/ui/components/command";
...
interface MultiSelectProps
   ...
   */
  readonly options: MultiSelectOption[] | MultiSelectGroup[];
  /**
   ...
   */
  readonly deduplicateOptions?: boolean;
   ...
   * Optional, defaults to true.
   */
  readonly resetOnDefaultValueChange?: boolean;
  ...
  (
    ...
    const isGroupedOptions = React.useCallback(
      (
        ...
        return firstOpt !== undefined && "heading" in firstOpt;
      },
      []
    );
    ...
    const getAllOptions = React.useCallback((): MultiSelectOption[] => {
      ...
      if (env.VITE_NODE_ENV === "development" && duplicates.length > 0) {
    ...
    const getOptionByValue = React.useCallback(
      (value: string): MultiSelectOption | undefined => {
        ...
        if (!option && env.VITE_NODE_ENV === "development") {
          console.warn(
