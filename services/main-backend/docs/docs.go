...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_administration_handler.statusResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_files_handler.statusResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_identity_handler.statusResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                        "description": "Customer ID (required only in debug auth bypass)",
                        "name": "customer_id",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "internal_administration_handler.statusResponse": {
            "type": "object",
            "properties": {
                "module": {
                    "type": "string",
        ...
        "internal_files_handler.statusResponse": {
            "type": "object",
            "properties": {
                "module": {
                    "type": "string",
        ...
        "internal_identity_handler.statusResponse": {
            "type": "object",
            "properties": {
                "module": {
                    "type": "string",
