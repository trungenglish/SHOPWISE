...
**Document Version:** 1.0 **Created Date:** {YYYY-MM-DD} **Last Updated:** {YYYY-MM-DD} **Status:** Draft | Review | Approved **Author:** {Author Name}
...
_Extracted from `docs/database-erd.dbml`_
...
_From `docs/ui-architecture-proposal.md`_
