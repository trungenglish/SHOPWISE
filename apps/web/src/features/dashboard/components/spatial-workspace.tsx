  ...
  return (
    <main className="relative flex h-full flex-1 flex-col overflow-hidden bg-transparent p-4 select-none">
        ...
        <AnimatePresence mode="wait">
          {displayProduct ? (
            <motion.div
              ...
              className="glass-card border-outline-variant/15 absolute top-4 left-4 z-20 flex w-[300px] flex-col gap-4 rounded-2xl border p-5 shadow-[0_15px_40px_-10px_rgba(79,124,255,0.15)]"
            >
      ...
      <div className="bg-surface-highest/80 border-outline-variant/40 z-20 mx-auto mb-2 flex w-full max-w-2xl items-center justify-between gap-5 rounded-full border px-6 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.5)] backdrop-blur-xl">
        ...
        <button
          onClick={onCheckout}
          className="cursor-pointer rounded-full bg-[#4F7CFF] px-5 py-2 font-mono text-[12px] font-black text-white shadow-[0_0_15px_rgba(79,124,255,0.4)] transition-[background-color] duration-200 ease-[var(--ease-out)] hover:bg-[#4F7CFF]/90"
        >
          Checkout
        </button>
      </div>
